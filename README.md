...
## ฟีเจอร์ My List (รายการโปรด)

- บันทึกรายการโปรดไว้ในเครื่องด้วย SharedPreferences (ออฟไลน์ได้)
- เพิ่ม/ลบจากหน้ารายละเอียดด้วยปุ่ม “My List” (สลับสถานะได้ทันที)
- ลากโปสเตอร์จากแถวใดๆ ไปวางบนไอคอนหัวใจที่มุมขวาบน AppBar เพื่อเพิ่มเข้า My List อย่างรวดเร็ว
- แถว “My List” จะแสดงบนหน้าแรกโดยอัตโนมัติเมื่อมีรายการโปรดแล้ว
